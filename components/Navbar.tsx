...
export const Navbar: React.FC = () => {
  return (
    <nav className="navbar md-px-12 md-py-8">
      ...
      <div className="hidden lg-flex space-x-12 text-olive font-semibold" style={{ fontSize: '10px', textTransform: 'uppercase', letterSpacing: '0.4em' }}>
        <a href="#hero" className="nav-link">Vision</a>
        <a href="#style" className="nav-link">Style</a>
        <a href="#contact" className="nav-link">Contact</a>
      </div>

      <div className="flex items-center md-h-12" style={{ height: '2.5rem' }}>
        <button className="btn btn-filled transition-all duration-500 hover-scale-105 active-scale-95 shadow-hover-olive" style={{ fontSize: '10px', letterSpacing: '0.4em' }}>
